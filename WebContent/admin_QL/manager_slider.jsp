            ...
            <table class="table">
                <thead class="thead-dark">
                    <tr>
                        ...
                        <th style="width: 200px" scope="col">Tên Sản phẩm</th>
                        <th style="width: 400px" scope="col">Ảnh slide</th>
                        <th style="width: 200px" scope="col">Tên slide</th>
         ...
         <% 
                    ...
                    <tr>
                        ...
                        <td><%=productGet.getProduct(sl.getProduct_id()).getProductName()%></td>
                          ...
                          <td><img width="70%" height="100" class="hinhql" src="/dienthoai/imagesphone/<%=sl.getImages_slider()%>"/></td>
                           <td><%=sl.getSlider_name()%></td>
                       
                        <td class="tt">
                             <a  href="/dienthoai/sliderServlet?command=delete&slider_id=<%=sl.getSlider_id()%>"><img src="${root}/admin_QL/images/de.png"></a>
                            <a href="${root}/admin_QL/update_slider.jsp?command=update&slider_id=<%=sl.getSlider_id()%>"><img src="${root}/admin_QL/images/e.png"></a>
                        </td>
                    </tr>
                   <%} %>
                </tbody>
