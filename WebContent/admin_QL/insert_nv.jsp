        ...
        <div class="main-right">
            ...
            <div class="edit-product">
                <form action="/dienthoai/ManagerNhanVien" method="post">
                    ...
                    <input class="form-control" type="text" name="nv_name" placeholder="name...">
                    <p>Thêm mail</p>
                    <input class="form-control" type="text" name="nv_mail" placeholder="mail...">
                    <p>Thêm địa chỉ</p>
                    <input class="form-control" type="text" name="nv_diachi" placeholder="dia chi...">
                    <p>Thêm số điện thoại</p>
                    <input class="form-control" type="text" name="nv_sdt" placeholder="phone...">
                    <p>Thêm Chức vụ</p>
