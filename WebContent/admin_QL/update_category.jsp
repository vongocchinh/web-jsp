        ...
        <div class="main-right">
            ...
            <div class="edit-product">
                <form action="/dienthoai/ManagerCategoryServlet" method="post">
               	 	<p>Mã danh muc</p>
                    <input class="form-control" name="maDanhMuc" type="hidden" value="<%=category.getCategoryID()%>">
                    <p>Thêm Danh Muc</p>
                    <input class="form-control" type="text" name="tenDanhMuc"  value="<%=category.getCategoryName()%>">
