        ...
        <div class="main-right">
            ...
            <div class="edit-product">
                <form action="/dienthoai/ManagerNhanVien" method="post">
               	 	<p>Mã nhân viên</p>
                    <input class="form-control" name="nv_id"" type="hidden" placeholder="mã...">
                    <p>Thêm tên nhân viên</p>
                    <input class="form-control" type="text" name="nv_name" placeholder="name..." value="<%=nv.getNv_name()%>">
                    <p>Thêm mail</p>
                    <input class="form-control" type="text" name="nv_mail" placeholder="mail..." value="<%=nv.getNv_mail()%>">
                    <p>Thêm địa chỉ</p>
                    <input class="form-control" type="text" name="nv_diachi" placeholder="dia chi..." value="<%=nv.getNv_diachi()%>">
                    <p>Thêm số điện thoại</p>
                    <input class="form-control" type="text" name="nv_sdt" placeholder="phone..." value="<%=nv.getSdt()%>">
                    <p>Thêm Chức vụ</p>
                    <select class="mdb-select md-form form-control" name="chucvu_id" >
                     		<%
