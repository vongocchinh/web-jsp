...
<head>
	...
	<script type="text/javascript">
			<c:set var="myVal" value="${pageContext.request.contextPath}"/> 
        		...
        		%>
                    <tr>
                        ...
                        <td class="tt" >
                            ...
                            <a href="/dienthoai/ManagerBrandServlet?command=delete&brand_id=<%=brand.getBrandID()%>"><img src="${root}/admin_QL/images/de.png"></a>
                            <a href="${root}/admin_QL/update_brand.jsp?command=update&brand_id=<%=brand.getBrandID()%>"><img src="${root}/admin_QL/images/e.png"></a>
                        </td>
                    </tr>
                   <%} %>
                </tbody>
