...
<%} %>
    ...
    %>
    <a class="back" href="/dienthoai/admin_QL/manager_tc.jsp?pages=<%=back%>&&tc=1"><i class='far fa-arrow-alt-circle-left'></i></a>
                <%
   ...
   <a href="/dienthoai/admin_QL/manager_tc.jsp?pages=<%=i%>&&tc=1"><%=i%></a>
                <%} else {%>
    <a href="/dienthoai/admin_QL/manager_tc.jsp?pages=<%=i%>&&tc=1"><%=i%></a> 
        ...
        %>
    <a class="next" href="/dienthoai/admin_QL/manager_tc.jsp?pages=<%=next%>&&tc=1"><i class='far fa-arrow-alt-circle-right'></i></a>
</div>
 <% 
...
<%} %>
    ...
    %>
    <a class="back" href="/dienthoai/admin_QL/manager_tc.jsp?pages=<%=back%>&&tc=4"><i class='far fa-arrow-alt-circle-left'></i></a>
                <%
   ...
   <a href="/dienthoai/admin_QL/manager_tc.jsp?pages=<%=i%>&&tc=4"><%=i%></a>
                <%} else {%>
    <a href="/dienthoai/admin_QL/manager_tc.jsp?pages=<%=i%>&&tc=4"><%=i%></a> 
        ...
        %>
    <a class="next" href="/dienthoai/admin_QL/manager_tc.jsp?pages=<%=next%>&&tc=4"><i class='far fa-arrow-alt-circle-right'></i></a>
</div>
...
<%} %>
    ...
    %>
    <a class="back" href="/dienthoai/admin_QL/manager_tc.jsp?pages=<%=back%>&&tc=-77877681"><i class='far fa-arrow-alt-circle-left'></i></a>
                <%
   ...
   <a href="/dienthoai/admin_QL/manager_tc.jsp?pages=<%=i%>&&tc=-77877681"><%=i%></a>
                <%} else {%>
    <a href="/dienthoai/admin_QL/manager_tc.jsp?pages=<%=i%>&&tc=-77877681"><%=i%></a> 
        ...
        %>
    <a class="next" href="/dienthoai/admin_QL/manager_tc.jsp?pages=<%=next%>&&tc=-77877681"><i class='far fa-arrow-alt-circle-right'></i></a>
</div>
...
<%} %>
    ...
    %>
    <a class="back" href="/dienthoai/admin_QL/manager_tc.jsp?pages=<%=back%>&&tc=12"><i class='far fa-arrow-alt-circle-left'></i></a>
                <%
   ...
   <a href="/dienthoai/admin_QL/manager_tc.jsp?pages=<%=i%>&&tc=12"><%=i%></a>
                <%} else {%>
    <a href="/dienthoai/admin_QL/manager_tc.jsp?pages=<%=i%>&&tc=12"><%=i%></a> 
        ...
        %>
    <a class="next" href="/dienthoai/admin_QL/manager_tc.jsp?pages=<%=next%>&&tc=12"><i class='far fa-arrow-alt-circle-right'></i></a>
</div>
...
<%} %>
    ...
    %>
    <a class="back" href="/dienthoai/admin_QL/manager_tc.jsp?pages=<%=back%>&&tc=9"><i class='far fa-arrow-alt-circle-left'></i></a>
                <%
   ...
   <a href="/dienthoai/admin_QL/manager_tc.jsp?pages=<%=i%>&&tc=9"><%=i%></a>
                <%} else {%>
    <a href="/dienthoai/admin_QL/manager_tc.jsp?pages=<%=i%>&&tc=9"><%=i%></a> 
        ...
        %>
    <a class="next" href="/dienthoai/admin_QL/manager_tc.jsp?pages=<%=next%>&&tc=9"><i class='far fa-arrow-alt-circle-right'></i></a>
</div>
