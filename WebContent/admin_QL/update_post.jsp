        ...
        <div class="main-right">
            ...
            <div class="edit-product1">
                <form method="post" action="${root}/Baiviet">
               	 	<p>Mã bài viết</p>
                    <input class="form-control" name="post_id" type="hidden" placeholder="mã...">
                    <p>Tiêu đề bài viết</p>
                    <input class="form-control" name="post_name" type="text" placeholder="tiêu đề..." value="<%=post.getPost_name()%>">
                    <p>Thêm ảnh bài viết</p>
                    <input class="form-control" type="file" name="post_img" value="<%=post.getImg()%>">
                    <p>Thêm bài viết</p>
                    <textarea name="post_post" id="editor1" rows="10" cols="80" ><%=post.getPost_post() %></textarea>
                    <script>
