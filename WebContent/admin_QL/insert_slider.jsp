        ...
        <div class="main-right">
            ...
            <div class="edit-product">
                <form  action="${root}/insertSlider" method="post" enctype="multipart/form-data">
               	 	<p>Mã slide</p>
                    <input class="form-control" name="slider_id" type="hidden" placeholder="mã...">
                    <p>Thêm sản phẩm</p>
           ...
           for (Product b : productGettong.getListProduct()) {
            %>
                    ...
                    <input class="form-control" type="text" name="slider_name" placeholder="tiêu đề ...">
                    <p>Thêm ảnh slide</p>
                    <input class="form-control" type="file" name="slider_images" placeholder="ảnh ...">
