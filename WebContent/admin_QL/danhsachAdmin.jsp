...
if(useradmin111.isRoleAdmin()==false){
	 response.sendRedirect("/dienthoai/admin_QL/erro.jsp");
       ...
       ArrayList<userAdmin> listUser = userAdminGet1.getListUser();
            ...
            <table class="table">
                ...
                <% 
                    ...
                    <tr>
                        ...
                        <td class="tt">
                             <a href="/dienthoai/ManagerAdmin?command=delete&user_id=<%=user.getId()%>&role=<%=user.isRoleAdmin()%>"><img src="${root }/admin_QL/images/de.png"></a>
                            	<a href="/dienthoai/admin_QL/update_admin.jsp?user_id=<%=user.getId()%>&role=<%=user.isRoleAdmin()%>"><img src="${root }/admin_QL/images/e.png"></a>
                        </td>
                    </tr>
                   <%} %>
                </tbody>
