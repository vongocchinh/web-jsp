                                ...
                                <form action="${root}/ManagerProductServlet" method="post">
                                    ...
                                    <table class="table-insert">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="hidden" class="form-control" name="maSanPham" value="<%=product.getProductID()%>">
                                                <%=error%>
                                            </td>
                                        </tr>
                                ...
                                %>
                                                    ...
                                                    <%=error%>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="text" class="form-control" name="tenSanPham" value="<%=product.getProductName()%>">
                                                                <%=error%>
                                                            </td>
                                                        </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><input value="<%=product.getProductImage()%>" type="text" placeholder="tênhình.jpg||tenhinh.png" class="form-control" name="hinhdaidien">
                                                    <%=error%>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><b class="name-insert"> Hình Sau</b></td>
                                                <td><input value="<%=product.getProductImagenext()%>" type="text" placeholder="tênhình.jpg||tenhinh.png" class="form-control" name="hinhmatsau">
                                                    <%=error%>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" class="form-control" name="gia" value="<%=product.getProductPrice()%>">
                                                    <%=error%><b> VNĐ</b></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><textarea name="mota" id="editor1" rows="10" cols="80">
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" class="form-control" placeholder="" name="giam_Gia" value="<%=product.getGiam_Gia()%>">
                                                    <%=error%>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" class="form-control" name="camera_Sau" value="<%=product.getCamera_Sau()%>"></td>
                                            </tr>
                                            <tr>
                                                <td><b class="name-insert">Camera_Truoc</b></td>
                                                <td><input type="text" class="form-control" name="camera_Truoc" value="<%=product.getCamera_Truoc()%>"></td>
                                            </tr>
                                            <tr>
                                                <td><b class="name-insert">He dieu Hanh</b></td>
                                                <td><input type="text" class="form-control" name="he_Dieu_Hanh" value="<%=product.getHe_Dieu_Hanh()%>"></td>
                                            </tr>
                                            <tr>
                                                <td><b class="name-insert">Bo Nho </b></td>
                                                <td><input type="text" class="form-control" name="bo_Nho" value="<%=product.getBo_Nho()%>"></td>
                                            </tr>
                                            <tr>
                                                <td><b class="name-insert">Ram</b></td>
                                                <td><input type="text" class="form-control" name="ram" value="<%=product.getRam()%>"></td>
                                            </tr>
