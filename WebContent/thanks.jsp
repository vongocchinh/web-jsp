...
%>
    ...
    <div class="container">
        ...
        <div class="pr-main-right">
            <h3 class="h3"> </h3>
            <div class="form-tt">
                <h3>Cảm Ơn Bạn Đã Đến Với Chúng Tôi </h3>
                <div class="active-tt">

                    <a class="back" href="index.jsp">Trang Chủ</a>
                    <a class="back" href="cart.jsp">Giỏ Hàng</a>
                    <a class="back" href="myaccount.jsp">Tài Khoản</a>
                    <a class="back" href="/dienthoai/LogoutServlet?command=logout">Đăng Xuất</a>
                </div>
