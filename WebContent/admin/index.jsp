   ...
   <jsp:include page="header1.jsp"></jsp:include>
    <div class="container-left-top-index" >
        <div class="container-top-index" >
            <div class="container-top-index-search">
                <div class="search-index-top-left">
                    <input style="outline: none;border: none;" type="search" class="search-top-index" placeholder="Search...">
                </div>
            ...
            <div class="container-top-index-main">
                <div class="post-index-row-1">
                    ...
                    <div class="row1-post-text-2">
                        <span class="row1-post-text-2-2"><a href=""><img class="img-text-2" src="${root}/images/images/hone.png"></a></span>/<span class="row1-post-text-2-2"><a href="index.jsp">Dashboards</a> </span> </span>
                    </div>
                ...
                <div class="post-index-row-2">
                    <div class="post-index post-index1">
                    ...
                    <div class="post-index post-index2">
                        <div class="post2-index ">
                    ...
                    <div class="post-index post-index3">
                        <div class="post2-index ">
                    ...
                    <div class="post-index post-index4">
                        <div class="post2-index ">
        ...
        <div class="container-footer-index">
            <div class="row-fooetr-index" style="">
            ...
            <div class="row-fooetr-index_2">
                <div class="row-fooetr-index_2_in">
                    <div class="row-fooetr-index_2_in-div">
                        <a href="manager_bill.jsp" class="footer-index-2">Đơn Hàng</a>
                    </div>
                    <div class="row-fooetr-index_2_in-div">
                        <a href="manager_newsletter.jsp" class="footer-index-2">Newsletter</a>
                    </div>
                    <div class="row-fooetr-index_2_in-div">
                        <a href="manager_contact.jsp" class="footer-index-2">ConTact</a>
                    </div>
                </div>
        ...
        <!-- <div class="marqee">
        	<marquee direction="right">Bạn Đang Truy cập Vào Quản Lí Admin</marquee>
        </div> -->
        <div class="clear"></div>
        <div class="table-kh">
        <h4>Data Tables</h4>
