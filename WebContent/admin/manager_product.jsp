...
%>
    ...
    %>
    <a class="back" href="${root }/admin/manager_product.jsp?pages=<%=back%>"><i class='far fa-arrow-alt-circle-left'></i></a>
                <%
    ...
    <a href="${root }/admin/manager_product.jsp?pages=<%=i%>"><%=i%></a>
                <%} else {%>
    <a href="${root }/admin/manager_product.jsp?pages=<%=i%>"><%=i%></a> 
        ...
        %>
    <a class="next" href="${root }/admin/manager_product.jsp?pages=<%=next%>"><i class='far fa-arrow-alt-circle-right'></i></a>
</div>
